...
class Task(_Task):
    ...
    def init(
        ...
        try:
            ...
            if not cls._monitor_use_subprocess:
        ...
        BackgroundMonitor.start_all(execute_in_subprocess=task._monitor_use_subprocess)
    ...
    def __shutdown(self):
        ...
        if not is_sub_process:
            ...
            try:
                ...
                import traceback
                stdout_print('__shutdown! 9 ', ex, os.getpid(), traceback.print_exc())
        ...
        stdout_print('PROCESS REALLY OUT!', os.getpid())
